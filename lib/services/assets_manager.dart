...
// general images
  static String upload = "$imagesPath/upload.png";
  static String electro = "$imagesPath/electro.jpg";
  static String elec = "$imagesPath/elec.jpg";
  static String personne = "$imagesPath/personne.png";
  ...
  static String confettis = "$imagesPath/confettis.png";
